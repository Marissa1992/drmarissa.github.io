...
export const metadata: Metadata = {
  ...
  description:
    'Expert vertigo diagnosis and treatment in Thiruvananthapuram. Specialised vestibular rehabilitation, Epley's manoeuvre, and personalised care at Dr. Marissa\'s ENT Clinic, Pongumoodu.',
  openGraph: {
    title: 'Vertigo Treatment in Thiruvananthapuram | Dr. Marissa ENT Clinic',
    description:
...
const structuredData = {
  ...
  mainContentOfPage: {
    '@type': 'MedicalTherapy',
    name: 'Vestibular Rehabilitation and Epley's Manoeuvre',
  },
  author: {
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                { step: '02', title: 'Epley's Manoeuvre', desc: 'A highly effective, in-clinic repositioning procedure for BPPV that moves dislodged crystals back into position — often providing immediate relief.' },
        ...
        <section className="bg-white py-12 px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-5">
              {[
                { q: 'Can vertigo be permanently cured?', a: 'BPPV, the most common type, can often be resolved in one or two clinic visits with the Epley's manoeuvre. Other types may require ongoing management, but most patients achieve significant improvement with proper treatment.' },
